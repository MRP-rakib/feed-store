...
export default function YearlyReport() {
  const expenseCategories: ExpenseItem[] = [
    { id: 1, name: 'মুরগির খাবার', amount: '৳ ২৫,০০,০০০', percentage: '৭০.০০%', icon: 'food-apple' },
    { id: 2, name: 'হাঁসের খাবার', amount: '৳ ৫,০০,০০০', percentage: '১৪.০০%', icon: 'duck' },
    { id: 3, name: 'গরুর খাবার', amount: '৳ ৩,০০,০০০', percentage: '৮.৫৭%', icon: 'cow' },
    { id: 4, name: 'অন্যান্য', amount: '৳ ২,০০,০০০', percentage: '৫.৭১%', icon: 'dots-grid' },
  ];

  return (
    <ScrollView contentContainerStyle={{ padding: 16 }} showsVerticalScrollIndicator={false}>
      {/* মাস/তারিখ নির্বাচন */}
      <Text className="text-sm font-bold text-gray-800 mb-2">বছর নির্বাচন করুন</Text>
      <TouchableOpacity className="flex-row justify-between items-center bg-white border border-gray-200 rounded-lg px-3 py-2.5 mb-5">
        <Text className="text-base text-gray-800">2026</Text>
      ...
      <View className="mb-6">
        <View className="flex-row justify-between items-center bg-[#43A047] px-4 py-5 rounded-xl mb-3">
          <Text className="text-white text-base font-semibold">বছরের মোট বাচ্চা</Text>
          <Text className="text-white text-xl font-bold">22,000</Text>
        </View>

        <View className="flex-row justify-between items-center bg-[#1E88E5] px-4 py-5 rounded-xl mb-3">
          <Text className="text-white text-base font-semibold">বছরের খাবারের খরচ</Text>
          <Text className="text-white text-xl font-bold">৳ ২৫,০০,০০০</Text>
        </View>

        <View className="flex-row justify-between items-center bg-[#E68A00] px-4 py-5 rounded-xl mb-3">
          <Text className="text-white text-base font-semibold">বছরের হাঁস খরচ</Text>
          <Text className="text-white text-xl font-bold">৳ ৫,০০,০০০</Text>
        </View>

        <View className="flex-row justify-between items-center bg-[#673AB7] px-4 py-5 rounded-xl">
          <Text className="text-white text-base font-semibold">বছরের সর্বমোট খরচ</Text>
          <Text className="text-white text-xl font-bold">৳ ৩৫,০০,০০০</Text>
        </View>
      </View>
